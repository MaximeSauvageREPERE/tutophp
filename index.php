...
$voitures = array(); // Stockage des objets dans un tableau

/* foreach($voitures as $voiture) {
    $voiture->setVitesse($voiture->getVitesse() + 20); // Augmente la vitesse de chaque voiture de 20 km/h
    $voiture->avancer(); // Affiche le message d'avancement de la voiture
}   
 */
